...
class WxPayOrderQuery extends WxPayDataBase
{
	...
	* 设置微信支付分配的sub商户号
	* @param string $value 
    * @author this set of methods are added by xunrui
	**/
	public function SetSub_mch_id($value)
	{
		$this->values['sub_mch_id'] = $value;
...
class WxPaySettlementQuery extends WxPayDataBase
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
	...
	**/
	...
	{
		return $this->values['date_start'];
	}
	/**
	* 判断下载对账单的日期，格式：20140603是否存在
	* @return true 或 false
	**/
	public function IsDate_startSet()
	{
		return array_key_exists('date_start', $this->values);
	}
	...
	**/
	...
	{
		return $this->values['date_end'];
	}
	/**
	* 判断下载对账单的日期，格式：20140603是否存在
	* @return true 或 false
	**/
	public function IsDate_endSet()
	{
		return array_key_exists('date_end', $this->values);
	}



	public function SetUsetag($value)
	{
		$this->values['usetag'] = $value;
	}
	public function GetUsetag()
	{
		return $this->values['usetag'];
	}
	public function IsUsetagSet()
	{
		return array_key_exists('usetag', $this->values);
	}
	...
	{
		return array_key_exists('limit', $this->values);
	}
}
